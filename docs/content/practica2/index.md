...
# Análisis del Modelo Orientado a Objetos
...
### Polimorfismo mediante Protocolos
...
### El Controlador (`app.py` y `cli.py`)
...
### Sesión 1 y 2: Lógica Base y CLI
